...
//		lblIconPanelInputIF.setHorizontalAlignment(SwingConstants.CENTER);
		...
		pnlGroupButtonLeft.add(Box.createRigidArea(new Dimension(0,20)));
		pnlGroupButtonLeft.add(this.btnKH);
		...
		this.txtTK.addActionListener(new ActionListener() {
		...
		this.txtTK.addMouseListener(new MouseListener() {
		...
		this.jPasswordField.addActionListener(new ActionListener() {
		...
		this.jPasswordField.addMouseListener(new MouseListener() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(this.btnQL)) {
			...
			if(!Role.equals("KH")) {
				...
				if(resultLogin != null) {
					utils.Contains.setMaNV(resultLogin.getMaNV());
