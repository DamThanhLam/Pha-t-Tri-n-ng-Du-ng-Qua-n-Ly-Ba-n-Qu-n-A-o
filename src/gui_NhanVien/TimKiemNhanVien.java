...
public class TimKiemNhanVien extends JPanel implements ActionListener{
	...
	private void createGUI() {
		...
		setButtonEven(buttonXoaTrang,buttonTinKiem);
	...
	private void setButtonEven(JButton... button) {
	...
	private void AnhXa() {
		...
		comboBoxGioiTinh= new JComboBox<String>(arrGioiTinh);
		comboBoxChucVu= new JComboBox<String>(arrChucVu);
